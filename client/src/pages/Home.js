    ...
    <div className="home-page">
      <AdaptiveContainer>
        ...
        <p className="course-description">
          Наш курс поможет вам с нуля разобраться в работе маркетплейса и построить прибыльный бизнес. Вы получите пошаговую инструкцию и все необходимые инструменты для запуска продаж на Wildberries.
        </p>
